class ReservationsController < ApplicationController
  def index
    ...
    @reservations = @q.result(:distinct => true).includes(:childcare_hours, :available_hours).page(params[:page]).per(10)
  ...
  def create
    ...
    @reservation.childcare_hours = params[:childcare_hours]
    @reservation.available_hours = params[:available_hours]
